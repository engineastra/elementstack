...
const ProjectBanner = () => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row w-full px-[20px] min-h-[200px] p-[20px] items-center justify-around border border-project-500 rounded-xl bg-opacity-10 overflow-hidden gap-[35px]">
